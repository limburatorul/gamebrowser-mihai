...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      'New: somewhere to keep how long a game takes — main story, main plus extras, completionist — shown at the top of the ⓘ details panel, above the description. A button in the Edit dialog opens the game on howlongtobeat.com in your browser so you can read the numbers off; they are not collected automatically, because reading that site by machine means working around protection its owners put there deliberately.'
    ]
  },
  {
    version: '2.10.0',
