 ...
 * being handed the Far Cry 5 trainer: plain substring matching says one
 * contains the other, and they are different games. Roman numerals count too,
 * so Van Helsing doesn't collect the Van Helsing III trainer.
 */
function seriesNumber(raw: string): number | null {
...
function extraIsOnlyEditionNoise(longer: string, shorter: string): boolean {
